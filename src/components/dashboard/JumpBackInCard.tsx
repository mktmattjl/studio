...
export function JumpBackInCard() {
  const learningItem: CurrentLearningItem = {
    ...
    progress: 70,
    imageUrl: 'https://placehold.co/800x450/151A21/9CA3AF.png', // Placeholder dark image
    description: 'Dive deeper into React state management, context API, and performance optimization techniques.'
  };

  return (
    // This card might span multiple columns in a grid layout on the dashboard
      ...
      <div className="md:flex">
        <div className="md:w-2/5 h-56 md:h-auto relative">
           <Image 
            ...
            layout="fill" // Use layout fill for responsive image background
            objectFit="cover" // Ensure image covers the area
            className="rounded-l-lg md:rounded-t-none md:rounded-l-lg" // Adjust rounding
        ...
        <div className="p-6 md:p-8 md:w-3/5 flex flex-col justify-center">
          ...
          <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-2">{learningItem.title}</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button size="lg" className="btn-primary-action flex-1 sm:flex-none"> {/* Use specific class for styling */}
